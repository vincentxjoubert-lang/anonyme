...
verify_quad9_dot \
    || die "Quad9 DoT non confirmé après le rétablissement du réseau (TCP/853 peut être bloqué)."
...
aa-status --enabled
verify_quad9_dot \
    || die "L'audit final ne confirme pas Quad9 DNS over TLS."
